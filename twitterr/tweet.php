...
<head>
  ...
  <link rel="stylesheet" href="tweett.css"></link>
</head>
<body>
  ...
  <div>
    ...
    <aside class="left-side">
      ...
      <div class="profile-btn">
        ...
        <div>
          ...
          <span class="tag">@BaranselAygun</span>
          </div>
          <div>
          <svg viewBox="0 0 24 24" aria-hidden="true">
            <g>
    ...
    <section class="content">
      ...
      <div class="post">
        ...
        <div class="right-column">
          ...
          <div>
          require_once('Affichemessage.php');
            <strong>
              <span>Onur Aygün Baransel</span>
            </strong>
              <span class="tag">@BaranselAygun</span>
              <span class="dot">.</span>
        ...
        <div class="right-column">
          ...
          <div>
            ...
            <div class="details">
              ...
              <p>This clone is not responsive. Also there are shortcomings.</p>
    ...
    <aside class="right-side">
      ...
      <!-- User Item Start -->
        <div class="user">
          <img class="profile-image" src="https://pbs.twimg.com/profile_images/958997253892419586/Jb6NPqEa_400x400.jpg">
          <div>
          <div>
